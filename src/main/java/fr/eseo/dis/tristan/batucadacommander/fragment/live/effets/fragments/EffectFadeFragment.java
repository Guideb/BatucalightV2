 ...
 */
public class EffectFadeFragment extends EffectFragmentContainer<OnEffectInteraction> {
     ...
     */
    public static EffectFadeFragment newInstance() {
        return new EffectFadeFragment();
    }
    ...
    void configureModules() {
        ...
        paramsNeeded.add(ParamEnum.INTENSITY);
